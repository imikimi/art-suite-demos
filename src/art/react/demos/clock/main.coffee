...
DateComponent = createComponentFactory
  module: module
  render: ->
    months = wordArray "January February March April May June July August September October November December"
    d = new Date
    Element
      size: xw: .45, hch:1
      location: ps: .5
...
ClockFace = createFluxComponentFactory
  module: module
...
module.exports = createComponentFactory class Clock extends Component
  module: module
