...
defineModule module, ->
  AbstractButton = createWithPostCreate class AbstractButton extends Component
  ...
  makeAnimatorComponents = (settings) ->
    array settings, ({buttonProps, rectangleProps, textProps, children}, name) ->
      ...
      createWithPostCreate class AnimatorComponent extends Component
  ...
  ContinuousButton = createWithPostCreate class ContinuousButton extends Component
  ...
  class MyComponent extends Component
    ...
    render: ->
      Element
        ...
        array @buttonProps, (component, i) =>
          AbstractButton {component, color: hslColor (i%@buttonProps.length)/@buttonProps.length, .8, .6}
